...
{"id":"event_validate_$MNM_FINDING_ID","run_id":"run_validate","type":"verdict.recorded","object":"verdict","object_id":"verdict_validate_$MNM_FINDING_ID","task_id":"$MNM_TASK_ID","timestamp":"2026-01-01T00:00:00Z","data":{"finding_id":"$MNM_FINDING_ID","phase":"validate","value":"proven","reason":"proven by fake opencode","canonical_finding_id":""}}
{"id":"event_done_$MNM_FINDING_ID","run_id":"run_validate","type":"task.completed","object":"task","object_id":"$MNM_TASK_ID","task_id":"$MNM_TASK_ID","timestamp":"2026-01-01T00:00:01Z","data":{"status":"completed","summary":"done"}}
EOF
printf '{"type":"done"}\n'
`
